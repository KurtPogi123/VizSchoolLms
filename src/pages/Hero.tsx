  ...
  return (
    <div className="hero-container relative min-h-screen bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-32 right-20 w-0 h-0 border-l-6 border-r-6 border-b-10 border-l-transparent border-r-transparent border-b-white opacity-60 animate-bounce" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-40 left-32 w-0 h-0 border-l-8 border-r-8 border-b-12 border-l-transparent border-r-transparent border-b-white opacity-70 animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/3 right-1/4 w-0 h-0 border-l-10 border-r-10 border-b-15 border-l-transparent border-r-transparent border-b-white opacity-50 animate-ping" style={{animationDelay: '0.5s'}}></div>

        {/* Additional Triangles behind persons */}
        <div className="absolute top-60 left-1/4 w-0 h-0 border-l-6 border-r-6 border-b-8 border-l-transparent border-r-transparent border-b-white opacity-40 animate-pulse" style={{animationDelay: '1.5s'}}></div>
        <div className="absolute top-72 right-1/3 w-0 h-0 border-l-8 border-r-8 border-b-12 border-l-transparent border-r-transparent border-b-white opacity-50 animate-bounce" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-48 left-1/2 w-0 h-0 border-l-5 border-r-5 border-b-7 border-l-transparent border-r-transparent border-b-white opacity-60 animate-ping" style={{animationDelay: '0.8s'}}></div>
        ...
        <div className="absolute top-1/2 right-16 w-16 h-16 bg-white rounded-full opacity-40 animate-bounce" style={{animationDelay: '1.5s'}}></div>
        <div className="absolute bottom-32 right-1/3 w-8 h-8 bg-white rounded-full opacity-70 animate-pulse" style={{animationDelay: '3s'}}></div>

        {/* Additional Circles behind persons */}
        <div className="absolute top-84 left-3/3 w-10 h-10 bg-white rounded-full opacity-50 animate-bounce" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-80 right-1/4 w-14 h-14 bg-white rounded-full opacity-45 animate-pulse" style={{animationDelay: '2.5s'}}></div>
        <div className="absolute bottom-56 left-2/3 w-6 h-6 bg-white rounded-full opacity-65 animate-ping" style={{animationDelay: '0.5s'}}></div>
        ...
        <div className="absolute top-1/2 right-1/3 text-white text-2xl opacity-60 font-light animate-spin" style={{animationDuration: '8s'}}>+</div>
        ...
        <div className="absolute bottom-20 left-16 w-24 h-24 bg-gradient-to-tr from-white/8 to-transparent rounded-full blur-lg animate-pulse" style={{animationDelay: '4s'}}></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
            ...
            <div className="group bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
              ...
              <div className="text-white text-4xl md:text-5xl font-black mb-3 group-hover:text-blue-100 transition-colors duration-300">95%</div>
              <div className="text-white/90 text-sm md:text-base font-medium leading-relaxed">
                Students enjoy<br />Newcastle
              </div>
            </div>
            ...
            <div className="group bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
              ...
              <div className="text-white text-3xl md:text-4xl font-black mb-3 group-hover:text-blue-100 transition-colors duration-300">9 out of 10</div>
              <div className="text-white/90 text-sm md:text-base font-medium leading-relaxed">
                Parents love the<br />flexibility
              </div>
            </div>
            ...
            <div className="group bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
              ...
              <div className="text-white text-4xl md:text-5xl font-black mb-3 group-hover:text-blue-100 transition-colors duration-300">85%</div>
              <div className="text-white/90 text-sm md:text-base font-medium leading-relaxed">
                Students feel<br />more confident
              </div>
            </div>
            ...
            <div className="group bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
              ...
              <div className="text-white text-3xl md:text-4xl font-black mb-3 group-hover:text-blue-100 transition-colors duration-300">4 out of 5</div>
              <div className="text-white/90 text-sm md:text-base font-medium leading-relaxed">
                Students book<br />multiple courses
              </div>
            </div>
            ...
            <div className="group bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
              <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center bg-white/20 rounded-2xl group-hover:scale-110 transition-transform duration-300">
                <img 
                  ...
                  alt="Certificate trophy" 
                  className="w-10 h-10 object-contain"
                />
              </div>
              <div className="text-white text-4xl md:text-5xl font-black mb-3 group-hover:text-blue-100 transition-colors duration-300">100%</div>
              <div className="text-white/90 text-sm md:text-base font-medium leading-relaxed">
                Students earn<br />certificates
              </div>
            </div>
          </div>
        </div>
