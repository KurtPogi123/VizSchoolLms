      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8 ml-8">
            ...
            <a href="#" className="text-gray-700 hover:text-blue-600 font-medium">Course</a>
      ...
      {isOpen && (
        <div className="md:hidden border-t border-gray-100">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white">
            ...
            <a href="#" className="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium">Course</a>
            <a href="#" className="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium">Reviews</a>
            <a href="#" className="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium">Programmes</a>
            <a href="#" className="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium">Plans</a>
