...
const InputComponent = React.forwardRef<HTMLInputElement, React.ComponentProps<"input">>(
  ({ className, ...props }, ref) => (
    <Input
      className={cn("rounded-e-lg rounded-s-none text-sm lg:!text-base py-5 md:py-6", className)}
      {...props}
      ref={ref}
    />
  )
    ...
    <Popover
      ...
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="py-5 md:py-6 flex gap-1 rounded-e-none rounded-s-lg border-r-0 px-3 focus:z-10 pointer-events-none"
          disabled={disabled}>
